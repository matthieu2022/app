...
export const Backpack = ({
  ...
  <div className="w-full md:w-[600px] lg:w-[800px] mx-auto mt-4 md:mt-[8rem] px-4">
    <div className="relative w-full h-full">
      ...
      <div className="grid grid-cols-2 gap-[8rem] md:gap-[7rem] lg:gap-[2rem] xl:gap-[5rem] 2xl:gap-[8rem] relative w-[250px] z-10 mt-[50px] lg:mt-[85px]ml-[160px] lg:ml-[154px]">
        {/* Colonne Soft Skills */}
