...
export const Backpack = ({
  ...
  <div className="w-full md:w-[600px] lg:w-[800px] mx-auto mt-4 md:mt-[7rem] px-4">
    <div className="relative w-full h-full">
      ...
      <div className="grid grid-cols-2 gap-[8rem] md:gap-[7rem] lg:gap-[6rem] xl:gap-[5rem] 2xl:gap-[4rem] relative w-[250px] z-10 mt-[50px] ml-[160px]">
        {/* Colonne Soft Skills */}
        <div className="space-y-2 w-[175px] md:mt-[225px] md:w-[175px] lg:mt-[170px] lg:w-[150px] xl:mt-[155px] xl:w-[145px] 2xl:mt-[225px] 2xl:w-[175px]">
          {skills.backpack.slice(0, 5).map((skill, index) => (
            <div
              ...
              className="h-16 border-2 border-dashed border-blue-300 rounded-lg flex items-center justify-center ml-4"
            >
              {skill && (
                <div
                  draggable
        ...
        <div className="space-y-2 w-[175px] md:mt-[225px] md:w-[175px] lg:mt-[170px] lg:w-[150px] xl:mt-[155px] xl:w-[145px] 2xl:mt-[225px] 2xl:w-[175px]">
          {skills.backpack.slice(5, 10).map((skill, index) => (
            <div
              ...
              className="h-16 border-2 border-dashed border-pink-300 rounded-lg flex items-center justify-center ml-4"
            >
              {skill && (
                <div
                  draggable
